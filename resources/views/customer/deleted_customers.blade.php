                ...
                <div class="card-header">
                    ...
                    <div class="col-md-2">
                        <form action="{{ route('customers.index') }}" method="GET" class="form-order">
                            <div class="input-group mb-3">
                                <select class="form-select" name="order" onchange="$('.form-order').submit()">
                                    <option @selected(request()->order) value="desc">Newest to Old</option>
                                    <option @selected(request()->order) value="asc">Old to Newest</option>
                                </select>
                            </div>
                        </form>
                    </div>
                        ...
                        <tbody>
                            @foreach ($customers as $customer)
                                ...
                                <td>
                                    ...
                                    if(confirm('Are you sure you want to permently delete the user?'))
